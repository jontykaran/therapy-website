  ...
  return (
    <section className="py-20 md:py-28 bg-sage-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <AnimatedSection>
          <p className="text-blush-400 font-medium text-sm tracking-widest uppercase mb-3">Education & Training</p>
          ...
          {qualifications.map((qual, idx) => (
            <AnimatedSection key={qual.degree} delay={idx * 0.1}>
              <div className="flex items-start gap-4 bg-white rounded-xl p-5 border border-sage-100">
                <div className="shrink-0 w-12 h-12 rounded-lg bg-blush-100 flex items-center justify-center">
